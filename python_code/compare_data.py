...
location_ForPlots='/users/dmitryreznik/To be backed up/working files/LSr0x2MnO3JPark/Comp54/'+ProjectDir
...
datasetdir2='/users/dmitryreznik/To be backed up/working files/LSr0x2MnO3JPark/nxspe054Ei_335K_Ebin0p5ZB/'+ProjectDir + 'good_slices/'
        ...
        if filenames1[i]==filenames2[j]:
            ...
            for ii in range(0,len(energy1)):
                if energy(ii>0):
                    ...
                    intensity1[ii]=M1*intensity1[ii]/(1/(np.exp(energy1[ii]/(0.08617*T1))-1))
                    error1[ii]=M1*error1[ii]/(1/(np.exp(energy1[ii]/(0.08617*T1))-1))
