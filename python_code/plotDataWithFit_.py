...
class Plot:
    def __init__(self,params):
        ...
        self.params=params
        if os.path.exists(params.path_data+'binning.txt'):
            with open(params.path_data+'binning.txt') as f:
...
#        print(len(FitResultsArray))
        ...
        self.titleApend=" dH="+str(RSE_Constants.rawData.Deltah)+ " dK="+str(RSE_Constants.rawData.Deltak)+" dL="+str(RSE_Constants.rawData.Deltal)
